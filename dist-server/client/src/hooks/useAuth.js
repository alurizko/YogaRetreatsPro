...
var authStateCache = { user: null, checked: false };
export function useAuth() {
    var _this = this;
    var _a = useState(authStateCache), authState = _a[0], setAuthState = _a[1];
    var _b = useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("/api/auth/user", {
                                credentials: "include",
                            })];
                    case 1:
                        res = _a.sent();
    ...
    useEffect(function () {
        if (!isLoading) {
            var newState = { user: user, checked: true };
