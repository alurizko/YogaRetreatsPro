...
export default function RetreatCard(_a) {
    ...
    return (<Card className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <img src={retreat.imageUrl || "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=400"} alt={retreat.title} className="w-full h-48 object-cover"/>
      <CardContent className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href={"/retreat/".concat(retreat.id)}>
        ...
        {availableSpots <= 5 && availableSpots > 0 && (<Badge variant="destructive" className="mt-2 text-xs">
            Осталось мало мест!
          </Badge>)}
      </CardContent>
    </Card>);
